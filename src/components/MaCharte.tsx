    ...
    <section className=" font-montserrat">
      <div className="container mx-auto">
        <div className="flex justify-center items-center text-center w-full mb-10">
          ...
          <h1 className="mt-2 font-poppins text-[#002157] text-center text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl mb-4">
            NOTRE CHARTE
          </h1>
        ...
        <div className="pattern-container relative">
          ...
          <div className="relative z-10 p-8 text-black">
            <div className="flex flex-col md:flex-row justify-around mt-20 font-monstserrat text-center">
